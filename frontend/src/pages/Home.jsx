    ...
    <main className="bg-zinc-50 min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            ...
            <h1 className="text-white text-6xl font-black mt-8 leading-tight">
              Encuentra un amigo
              <span className="block text-amber-300">para toda la vida</span>
            </h1>

            <p className="text-white/80 text-xl mt-6 leading-relaxed">
              Cada mascota merece una segunda oportunidad. Descubre cientos de
              perros y gatos esperando una familia llena de amor.
            </p>
            ...
            <div className="flex gap-4 mt-10">
              ...
              <button className="bg-white/20 backdrop-blur-md border border-white/30 text-white px-8 py-4 rounded-2xl hover:bg-white/30 transition">
                Conocer más
              </button>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="flex justify-between items-center mb-10">
          <div>
            <h2 className="text-4xl font-bold">Mascotas destacadas</h2>
        ...
        {mascotas.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-zinc-500 mt-2">
              Pronto tendremos nuevos amigos esperando un hogar.
            </p>
          </div>
        ) : (
          <Swiper
      ...
      <section className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="text-4xl font-bold">Encuentra tu compañero ideal</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-bold mt-5">{item.titulo}</h3>

                <p className="text-gray-500 mt-2">{item.cantidad}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-orange-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold">¿Por qué adoptar?</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            {[
              ...
              },
              {
                ...
                texto:
                  "Cada adopción libera espacio para rescatar otra mascota.",
              },
              {
                emoji: "😊",
              ...
              >
                ...
                <h3 className="text-2xl font-bold mt-6">{item.titulo}</h3>

                <p className="text-gray-500 mt-4 leading-7">{item.texto}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold">¿Cómo adoptar?</h2>
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <p className="text-gray-500 mt-3">{item.texto}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-orange-500 py-20 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-10 text-center">
            <div>
              <h2 className="text-5xl font-black">250+</h2>

              <p className="mt-3">Mascotas adoptadas</p>
            </div>

            <div>
              <h2 className="text-5xl font-black">500+</h2>

              <p className="mt-3">Mascotas rescatadas</p>
            </div>

            <div>
              <h2 className="text-5xl font-black">98%</h2>

              <p className="mt-3">Adopciones exitosas</p>
            </div>

            <div>
              <h2 className="text-5xl font-black">35</h2>

              <p className="mt-3">Voluntarios</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold">Historias que inspiran</h2>
            ...
            {[
              {
                ...
                mascota: "Max",
                comentario:
                  "Adoptar a Max fue una de las mejores decisiones de nuestra familia. Hoy llena nuestro hogar de alegría.",
              },
              {
                nombre: "Carlos Pérez",
                mascota: "Luna",
                comentario:
                  "El proceso fue sencillo y transparente. Luna se adaptó muy rápido y ahora es parte de nuestra vida.",
              },
              {
                nombre: "Ana Torres",
                mascota: "Rocky",
                comentario:
                  "Gracias al albergue encontramos un compañero increíble. Recomiendo adoptar antes que comprar.",
              },
            ].map((item, index) => (
              <div
                key={index}
              ...
              >
                ...
                <p className="text-gray-600 leading-7">"{item.comentario}"</p>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center px-6">
          ...
          <p className="text-white/80 text-xl mt-6 max-w-2xl mx-auto">
            Cada mascota espera una familia que le brinde amor, protección y un
            hogar para siempre.
          </p>
      ...
      <footer className="bg-zinc-900 text-white">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid md:grid-cols-4 gap-10">
            <div>
              <h3 className="text-3xl font-bold">🐾 Can Martín</h3>

              <p className="text-zinc-400 mt-5 leading-7">
                Plataforma dedicada a conectar mascotas rescatadas con familias
                responsables que desean adoptar.
              </p>
            </div>

            <div>
              <h4 className="font-bold text-xl mb-5">Navegación</h4>

              <ul className="space-y-3 text-zinc-400">
                <li className="hover:text-white cursor-pointer">Inicio</li>

                <li className="hover:text-white cursor-pointer">Mascotas</li>

                <li className="hover:text-white cursor-pointer">Adopciones</li>
            ...
            <div>
              <h4 className="font-bold text-xl mb-5">Contacto</h4>
              ...
              <ul className="space-y-3 text-zinc-400">
                ...
                <li>✉ contacto@canmartin.com</li>
              </ul>
            </div>

            <div>
              <h4 className="font-bold text-xl mb-5">Síguenos</h4>
...
function PetCard({ pet }) {
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group border border-zinc-100">
      {/* Imagen */}
      <div className="relative overflow-hidden">
        ...
        />
        <span className="absolute top-4 left-4 bg-green-500 text-white px-3 py-1 rounded-full text-xs font-semibold shadow">
          Disponible
        </span>

        <button className="absolute top-4 right-4 w-11 h-11 rounded-full bg-white/90 backdrop-blur flex justify-center items-center shadow hover:bg-orange-500 hover:text-white transition">
          <Heart size={20} />
        </button>
      </div>
      ...
      <div className="p-6">
        <div className="flex justify-between items-start">
          <div>
            <h3 className="text-2xl font-bold text-zinc-800">{pet.nombre}</h3>

            <p className="text-orange-500 font-medium">{pet.raza}</p>
          </div>
        ...
        <p className="text-zinc-500 leading-7 mt-5 line-clamp-3">
          {pet.descripcion}
        </p>

        <button className="mt-8 w-full bg-orange-500 hover:bg-orange-600 text-white rounded-xl py-3 font-semibold transition duration-300">
          Ver Perfil
        </button>
      </div>
    </div>
